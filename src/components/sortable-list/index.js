export default class SortableList {
  ...
  placeHolderElement() {
    ...
    placeholder.innerHTML = '<li class="categories__sortable-list-item sortable-list__item sortable-list__placeholder"></li>';
  ...
  startDragging = (event) => {
    ...
    if (target) {
      ...
      this.oldPosition = [...this.element.children].indexOf(this.draggingElement);
      this.putPlaceHolderAfter(this.draggingElement);
      this.draggingElement.className = 'categories__sortable-list-item sortable-list__item sortable-list__item_dragging';
      this.draggingShift = {
  ...
  stopDragging = () => {
    ...
    if (this.draggingElement) {
      const newPosition = [...this.element.children].indexOf(this.draggingElement);
      this.draggingElement.className = 'categories__sortable-list-item sortable-list__item';

...
export default class ColumnChart {
  ...
  async loadData(from, to) {
    ...
    // Метод toISOString() возвращает строку в формате ISO (расширенный формат ISO 8601), 
    // который можно описать следующим
    //  образом: YYYY-MM-DDTHH:mm:ss.sssZ. Часовой пояс всегда равен UTC, что обозначено суффиксом "Z".
  ...
  getColumnBody(data) {
    ...
    // data = это объъект с ключем где дата, и значением в котором количество продаж

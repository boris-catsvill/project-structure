...
export default class Category {
  ...
  renderSubcategoryElement(id, name, count) {
  ...
  getSubcategoryElement(id, name, count) {
    const element = document.createElement('div');
    element.innerHTML = this.renderSubcategoryElement(id, name, count);
  ...
  async render() {
    ...
    this.sortableList = new SortableList({items: this.subcategories.map(subcategory =>
       this.getSubcategoryElement(subcategory.id, subcategory.title, subcategory.count))});

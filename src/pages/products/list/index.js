...
export default class ProductsListPage {
              ...
              <div class = "content-box content-box_small">
                <form class = "form-inline">
                  <div class = "form-group">
                    <label class = "form-label">Фильтровать по Названию:</label>
                    <input type = "text" data-element = "filterName" class = "form-control" placeholder = "Название товара">
                  </div>
                  <div class = "form-group" data-element = "sliderContainer">
                    <label class = "form-label">Цене:</label>
                  </div>
                  <div class = "form-group" data-element = "filterStatus">
                    <label class = "form-label">Статусу:</label>
  ...
  async renderComponents() {
    ...
    <div>
      ...
      <button data-element = "resetButton" type="button" class = "button-primary-outline">Сбросить фильтры</button>
    </div>`;

...
export default class EditProductPage {
  ...
  async renderComponents() {
    ...
    const productId = '105-planset-apple-ipad-air-2019-256-gb-3g-lte-serebristyj';

    this.components.productFrom = new ProductForm(productId);

    productForm.append(this.components.productFrom.element);
  }

  get template() {
    return `
    <div>
      <h1>Products /${this.productId ? 'Edit' : 'Add'}</h1>
...
//         imageListContainer.firstElementChild.append(newImageWrapper.firstElementChild);

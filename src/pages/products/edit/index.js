...
export default class Page {
  ...
  async initComponents() {
    const productId = (this.match[1]) ? this.match[1] : null;
  ...
  initEventListeners () {
    ...
    this.subElements.productForm.addEventListener("product-updated", this.onProductUpdate , { signal }); 
    this.subElements.productForm.addEventListener("product-saved", this.onProductUpdate , { signal });
  }
